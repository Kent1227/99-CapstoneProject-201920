...
def main():
    ...
    root = tkinter.Tk()
    root.title("CSSE Capstone Project")

    # -------------------------------------------------------------------------
    # The main frame, upon which the other frames are placed.
    # -------------------------------------------------------------------------

    mainframe = ttk.Frame(root, padding='15', borderwidth='5', relief='groove')
    mainframe.grid()
    ...
    teleop_frame, arm_frame, control_frame = get_shared_frames(mainframe,
                                                               mqtt_sender)
